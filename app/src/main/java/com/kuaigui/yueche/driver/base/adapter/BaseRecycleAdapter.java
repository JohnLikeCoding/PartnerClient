...
/**
 * @description: RecyclerView的通用Adapter，需重写convert(Helper helper, T item)方法
 * <p/>
 * 注意：convert(BaseCommonAdapter.Helper helper, T item);子类这个方法的参数需要一致，即BaseCommonAdapter.Helper
 * helper
 * <p/>
 * @date: 2017/12/1 0001 11:08
 */
public abstract class BaseRecycleAdapter
     ...
     * @param item   对应的数据
     */
    public abstract void convert(BaseRecycleHolder helper, T item, int position);
